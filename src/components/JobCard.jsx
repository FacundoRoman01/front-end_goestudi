...
// Asegúrate de que postedAgo sea recibido como prop
const JobCard = ({ company, location, title, isPaid, jobDetails, postedAgo }) => {
    ...
    return (
        <div className="job-card">
            <div className="job-header">
                ...
                {/* Descomenta esta sección para mostrar postedAgo */}
            ...
            <div className="job-footer">
                <button className={`btn btn-save ${isSaved ? 'saved' : ''}`} onClick={handleSaveClick}>
                    ...
                    <span>{isSaved ? 'Guardado' : 'Ahorrar'}</span>
                </button>
